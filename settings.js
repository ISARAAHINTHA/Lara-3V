...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "rRJWnZ5A#EfGlmqEikGr0ESWOkHaDEM5loLGtjVynXeEQ7We3QQ0", // Add your session id
...
STATUS_REPLY_MSG: process.env.STATUS_REPLY_MSG || "*_`ᴀᴜᴛᴏ ꜱᴛᴀᴛᴜꜱ ᴊᴜꜱᴛ ɴᴏᴡ ꜱᴇᴇɴ ʙʏ ℑꜱᴀʀᴀ `_* 🌸",
